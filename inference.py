...
ocr_model = BaseWordOCR(model_type='handwritten', triton_config={})  # Update triton_config if required

# Directory path containing images
directory_path = '/home/apurba/DATASET/data/ocr/hwrw_word/'

# Path to save CSV file
csv_file_path = './evaluation/hwrw_word.csv'

# Path to save exceptions CSV file
exceptions_csv_file_path = './evaluation/exceptions_hwrw_word.csv'
