...
# Print statement to indicate the start of the translation process
...
for index, row in df.iterrows():
    ...
    try:
        ...
        if translated_pairs % 2 == 0:
            ...
            # Print statement to indicate the number of pairs translated
            print(f"{translated_pairs} pairs translated.")

    except Exception as e:
        print(f"Error translating pair at index {index}: {e}")

# Print statement to indicate the end of the translation process
print("Translation process completed. Total translated pairs:", translated_pairs)
