...
def filter_and_parse_log(input_file, csv_file):
    ...
    with open(input_file, 'r') as f_in:
        for line in f_in:
            ...
            if "Successfully Completed Noise Removal" not in line and \
               "Produced to Logo Detection Queue" not in line:
...
# Specify the paths
input_file = 'noise_q_small.log'
csv_file = 'noise_removal_stats.csv'
