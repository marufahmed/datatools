...
ocr_model = BaseWordOCR(model_type='letterpress', triton_config={})  # Update triton_config if required

# Directory path containing images
directory_path = '/home/apurba/DATASET/data/ocr/lpw_word/'

# Path to save CSV file
csv_file_path = './evaluation/lpw_word.csv'

# Path to save exceptions CSV file
exceptions_csv_file_path = './evaluation/exceptions_lpw_word.csv'
